  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <div id="app">
      ...
      <div class="app-body">
        ...
        {{-- Se incia el contenido --}}
        @yield('contenido')
        {{-- fin del contenido --}}

        
        {{-- Se incia el aside la los tabs del lado del avatar --}}
        @include('partials.navDetail')
        {{-- Fin de el menu de detalles --}}
    ...
    <script src="https://www.jsdelivr.com/package/npm/tooltip-js"></script>
